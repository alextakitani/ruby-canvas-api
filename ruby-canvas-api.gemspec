require_relative 'lib/ruby_canvas_api/version'

Gem::Specification.new do |spec|
  spec.name = "ruby-canvas-api"
  spec.version = RubyCanvasApi::VERSION
  spec.authors = ["Alex Takitani"]
  spec.email = ["aftakitani@gmail.com"]

  spec.summary = 'Canvas LMS api wrapper'
  spec.description = 'Canvas LMS api wrapper'
